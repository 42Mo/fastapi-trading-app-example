...
class TestOrders:
    ...
    def test_post_order(self, order_input):
    ...
    def test_get_specific_order(self, order_input):
    ...
    def test_delete_order(self, order_input):
        post_response = requests.post(f'{base_url}/orders', data=json.dumps(order_input), headers={'Content-Type': 'application/json'})
        order_id = post_response.json()['id']
    ...
    def test_place_order_with_invalid_input(self):
    ...
    def test_place_order_with_wrong_type_input(self):
    ...
    def test_place_order_with_additional_fields(self):
    ...
    def test_place_order_with_negative_quantity(self):
    ...
    def test_place_order_with_no_quantity(self):
    ...
    def test_place_order_with_no_stocks(self):
    ...
    def test_place_order_with_non_string_stocks(self):
    ...
    def test_delete_order_twice(self, order_input):
        post_response = requests.post(f'{base_url}/orders', data=json.dumps(order_input), headers={'Content-Type': 'application/json'})
        order_id = post_response.json()['id']
